...
greet_by_name("Kavita")


# 3. No Return Type and with Default Argument ( # positional argument)
def say_hello_default_arg(name="Kavita"):
    print("Hello", name.upper())


say_hello_default_arg("Karunakaran")
...
multiple_args()
multiple_args("Franklin", "Jose")
multiple_args(name1="Kavita")
multiple_args(name1="Karunakaran", name2="Jefrin")
multiple_args(name2="Jorwin")
